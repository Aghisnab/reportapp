    ...
    <div class="card-body">
        ...
        <form action="{{ route('plan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="event_id" class="form-control" placeholder="Plan ID">
                @error('event_id')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_event" class="form-control" placeholder="Nama Plan">
                @error('nama_event')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="date" id="tanggal_mulai" name="tanggal_mulai" class="form-control" placeholder="Pilih Tanggal Mulai">
                @error('tanggal_mulai')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="date" id="tanggal_selesai" name="tanggal_selesai" class="form-control" placeholder="Pilih Tanggal Selesai">
