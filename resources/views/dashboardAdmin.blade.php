        ...
        <div id="layoutSidenav_content">
            ...
            <div class="container-fluid px-4">
                <!-- Dashboard Main Content -->
                    <div class="welcome-banner text-center mb-4" style="background-color: #f8f9fa; padding: 20px; border-radius: 10px;">
                        <h3 class="mt-4" style="font-size: 1.75rem; color: #007bff;">
                            <i class="fas fa-user-circle"></i> Selamat Datang Admin
                        </h3>
                                            ...
                                            <div class="border-radius-lg h-100">
                                                <div class="position-relative d-flex align-items-center justify-content-center h-100">
                                                    ...
                                                    @else
                                                        ...
                                                        <!-- <i class="fas fa-image fa-3x" style="color: #ccc;" aria-hidden="true"></i> -->
